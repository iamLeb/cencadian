...
<div id="preloader">
    <div id="loader" class="loader">
        <div class="loader-container">
            <div class="loader-icon"><img src="{{ asset('front/assets/img/logo/preloader.png') }}" alt="Preloader"></div>
        </div>
    </div>
</div>
<!--Preloader-end -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <ul class="tg-header__top-info left-side list-wrap">
                        <li><i class="flaticon-phone-call"></i><a href="tel:0123456789">+1 (204) 111 1111</a></li>
                ...
                <div class="col-lg-6">
                    <div class="about-content">
                        <div class="section-title mb-35 tg-heading-subheading animation-style3">
                            ...
                            <h2 class="title tg-element-title">We believe in the power of connections to drive growth and foster innovation.
                        ...
                        <p>Our mission is simple yet profound: to create a platform where interns can gain real-world experience, companies can access top-tier talent, and both parties can achieve their goals. We strive to cultivate a community of learning, collaboration, and opportunity, where every interaction fuels personal and professional growth.</p>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                        <div class="services-item shine-animate-item">
                            ...
                            <div class="services-content">
                                ...
                                <h4 class="title"><a href='services-details.html'>Mobile App Development</a></h4>
                                <p>Stay ahead in the digital era with our cutting-edge mobile app development services. Whether it's iOS, Android, or cross-platform applications, Cencadian ensures your brand remains accessible to users on the go.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                        <div class="services-item shine-animate-item">
                            ...
                            <div class="services-content">
                                ...
                                <h4 class="title"><a href='services-details.html'>Innovative Design and User Experience</a></h4>
                                <p>Unlock visually striking, user-friendly designs with Cencadian. Our creative team ensures every pixel reflects your brand, delivering an immersive user experience.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                        <div class="services-item shine-animate-item">
                            ...
                            <div class="services-content">
                                ...
                                <h4 class="title"><a href='services-details.html'>SEO and Digital Marketing</a></h4>
                                <p>Boost your online presence with Cencadian's SEO and Digital Marketing services. Our experts use strategic tactics to improve search rankings, drive organic traffic, and elevate visibility.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="request-content text-center tg-heading-subheading animation-style3">
                        <h2 class="title tg-element-title">Offering The Best Experience To Both Our Companies And Interns</h2>
