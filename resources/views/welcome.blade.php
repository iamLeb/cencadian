    ...
    <section class="banner-area banner-bg" data-background="{{ asset('front/assets/pexels-kassiamelox-19899183.jpg') }}">
        <div class="row justify-content-center">
            ...
            <div class="row justify-content-around">
                <div class="col-md-3 bg-opacity-75 bg-secondary rounded d-flex flex-column justify-around flex-column shadow-lg">
                    <h4 class="text-center" ><span style="color:#14176C">About The Summer Web Development Program</span></h4>
                    <p class="text-white text-center">
                        Cencadian Educational Incorporated is a Canadian not-for-profit organization seeking to provide engagement
                    ...
                    <a class='btn' data-aos-delay='600' data-aos='fade-up' href='/register?key=company'>Learn More about Cencadian</a>
                </div>

                <div class="col-md-3 bg-opacity-75 bg-secondary rounded d-flex flex-column">
                    <h4 class="text-white text-center"><span style="color:#14176C; font-weight:bold">Internship Opportunities for Youths</span></h4>
                    <p class="text-white text-center">
                        Are you a student looking to gain real-world experience in Web Development? Cencadian's Summer Web Development
                    ...
                    <a class='btn align-self-end' data-aos-delay='600' data-aos='fade-up' href='/register?key=intern'>Apply now</a>
                    
                </div>

                <div class="col-md-3 bg-opacity-75 bg-secondary d-flex flex-column rounded">
                    <h4 class="text-white text-center"><span style="color:#14176C; font-weight:bold">Web Presence Opportunities for Businesses</span></h4>
                    <p class="text-white text-center">
                        Are you a small or medium-sized business or community organization needing web development services?
                    ...
                    <a class='btn' data-aos-delay='600' data-aos='fade-up' href='/register?key=company'>Apply now</a>
                </div>
            </div>
        </div>
