...
@section('content')
    ...
    @if (auth()->user()->application && auth()->user()->isIntern())
        <div id="application-submitted" style="display: block;">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            <div>
                                ...
                                <p class="text-muted">Thank you for taking the time to apply for the Web Development
                                    Internship at The Cencadian Summer Web Development Program. We're thrilled to see your
                                    interest in joining our team and contributing to our projects.</p>
                                <p class="text-muted">Your application is now under review, and we'll be in touch soon to
                                    discuss the next steps in the hiring process.</p>
                                <p class="text-muted">In the meantime, feel free to explore our website and learn more about
                                    our company culture and the projects we're working on. If you have any questions or need
                                    further information, please don't hesitate to reach out to us at <a
                                        href="mailto:admin@cencadian.ca">admin@cencadian.ca</a></p>
                                <p class="text-muted">Thank you.</p>
                            </div>
                            <div class="text-center mt-4">
                                <button id="edit-application-button" class="btn btn-primary" onclick="toggleEditMode()">Edit
                                    Application</button>
                            </div>
                        </div>
                    </div>
        ...
        {{--  --}}
        <div id="edit-application" style="display: none;">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-5">
                                    <div class="flex-grow-1">
                                        <h5 class="card-title mb-0">Edit Your Application</h5>
                                    </div>
                                </div>
                                    ...
                                    @elseif(auth()->user()->isIntern())
                                        <form
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="designationInput" class="form-label">Current
                                                            School/University </label>
                                                        <input value="{{ auth()->user()->application->school ?? '' }}"
                                                            required name="school" type="text" class="form-control"
                                                            id="designationInput"
                                                            placeholder="University / College / HighSchool">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="websiteInput1" class="form-label">Skills (Seperate
                                                            with Coma (,))</label>
                                                        <input value="{{ auth()->user()->application->skills ?? '' }}"
                                                            required name="skills" type="text" class="form-control"
                                                            id="websiteInput1"
                                                            placeholder="MongoDB, Express, React, NodeJs..." />
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                ...
                                                <div class="col-lg-12 mb-3">
                                                    <p>Please provide contact information for 3 references who are familiar
                                                        with you and your capabilities.</p>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        <label for="ref1RelationshipInput"
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        <label for="ref3RelationshipInput"
                                                            class="form-label">Relationship</label>
                                                ...
                                                <div class="card-body">
                                                    <div>
                                                        ...
                                                        @else
                                                            <p class="text-muted">Upload Your Reśume here. (Only PDF
                                                                allowed)</p>
                                                            <div class="fallback">
                                                                <input class="form-control" required name="resume"
                                                                    type="file" />
                                                            </div>
                                                        @endif
                                                    </div>
                                ...
                                @elseif(auth()->user()->isIntern())
                                    <form action="{{ route('application.store') }}" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label for="websiteInput1" class="form-label">Skills (Seperate with
                                                        Coma (,))</label>
                                                    <input value="{{ auth()->user()->application->skills ?? '' }}"
                                                        required name="skills" type="text" class="form-control"
                                                        id="websiteInput1"
                                            ...
                                            <div class="col-lg-12 mb-3">
                                                <p>Please provide contact information for 3 references who are familiar with
                                                    you and your capabilities.</p>
                                            </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-5">
                                                    ...
                                                    <label for="ref1PrefPhoneInput" class="form-label">Phone</label>
                                                    <input type="radio" id="ref1PrefPhoneInput"
                                                        name="reference1_prefContact" value="phone" required />

                                                    <label for="ref1PrefEmailInput" class="form-label">Email</label>
                                                    <input type="radio" id="ref1PrefEmailInput"
                                                        name="reference1_prefContact" value="email" required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input required name="reference3_phone" type="phone"
                                                        class="form-control" id="ref3PhoneInput"
                                                        placeholder="Enter Reference 3's phone" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                <div>
                                                    ...
                                                    @else
                                                        <p class="text-muted">Upload Your Reśume here. (Only PDF allowed)
                                                        </p>
                                                        <div class="fallback">
                                                            <input class="form-control" required name="resume"
                                                                type="file" />
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3 pb-2">
                                                    <label for="exampleFormControlTextarea" class="form-label">Additional
                                                        Note (<small>Optional</small>)</label>
                                                    <textarea name="note" class="form-control" id="exampleFormControlTextarea"
                                                        placeholder="Enter any additional note" rows="3"></textarea>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            @if (auth()->user()->application)
                                                <div class="alert alert-success text-center">Application Submitted
                                                    Successfully </div>
                                            @else
                                                @if (!auth()->user()->isAdmin())
                                                    <div class="col-lg-12">
    ...
    <script>
        function toggleEditMode() {
            var form = document.getElementById('application-submitted');
            var eForm = document.getElementById('edit-application');
            var button = document.getElementById('edit-application-button');
