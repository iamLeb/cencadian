                                ...
                                <div class="col-md-auto">
                                    <div class="avatar-md">
                                        <div class="avatar-title bg-white rounded-circle">
                                            <img src="{{ asset('front/assets/img/favicon.png') }}" alt="" class="avatar-xs">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md">
                                    <div>
                                        <h4 class="fw-bold">Software Development Intern</h4>
                                        <div class="hstack gap-3 flex-wrap">
                                            <div><i class="ri-building-line align-bottom me-1"></i>Cencadian Educational Inc.</div>
                                            <div class="vr"></div>
...
<div class="row mt-n5">
    <div class="col-xxl-9">
        <div class="card">
            <div class="card-body">
                <h5 class="mb-3" style="font-weight:bold">Job Description</h5>

                <p class="text-muted mb-2">We are seeking a motivated Software Development Intern to join our team. As an intern, you will have the opportunity to work closely with our experienced developers on real-world projects, gaining valuable insights and practical experience in software development.</p>
                <div>
                    <h5 class="mb-3" style="font-weight:bold">Responsibilities of a Software Development Intern</h5>
                    <p class="text-muted">Provided below are the responsibilities of a Software Development Intern</p>
                    <ul class="text-muted vstack gap-2" style="font-weight:bold">
                        <li>Write custom HTML, CSS, and JavaScript, and APIs for existing websites and applications.</li>
                ...
                <div>
                    <h5 class="mb-3" style="font-weight:bold">Desirable Skills & Experience</h5>
                    <ul class="text-muted vstack gap-2" style="font-weight:bold">
                        <li>
                            <span style="font-weight:bold">A desire and willingness to learn</span>
                        </li>
                        <li>
                        ...
                        <li>
                            Familiarity with the industry & market trends
                        </li>
                    </ul>
                </div>
            ...
            <div class="card-body">
                <div class="table-responsive table-card">
                    <table class="table mb-0">
                        <tbody>
                        <tr>
                            <td class="fw-medium">Title/Role</td>
                            <td>Web Development Intern</td>
                        </tr>
                        <tr>
                            <td class="fw-medium">Company Name</td>
                            <td>Cencadian Educational Inc.</td>
                        </tr>
                        <tr>
